...
for SPLIT in "${SPLITS[@]}"; do
    for MODEL_NAME in "${DPR_LLMS[@]}"; do
        RAW_CLUSTER_PATH="data/output/${DATA_NAME}/${SPLIT}/${DATA_NAME}_${SPLIT}_filtered_clusters.json"
        CORPUS_PATH="data/output/${DATA_NAME}/${SPLIT}/${DATA_NAME}_${SPLIT}_corpus.json"
        OUTPUT_PATH="data/output/${DATA_NAME}/${SPLIT}/${DATA_NAME}_${SPLIT}_dprs-${MODEL_NAME}.jsonl"
