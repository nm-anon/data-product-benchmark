...
class ColBERTReranker:
    def __init__(self, model_name="colbert-ir/colbertv2.0"):
        print(f"Loading ColBERT reranker: {model_name}...")
    ...
    def rerank(self, query, documents, top_k=10):
        ...
        # RAGatouille returns a list of dicts with 'content', 'score', and 'rank'
        results = self.model.rerank(query=query, documents=documents, k=top_k)
        return results
...
# need to return the full content for colbert reranking
def hybrid_search(client, query_content, query_emb, collection_name = "text_collection", top_k = 2, rerank_config= "rrf"):
    ...
    res = client.hybrid_search(
        ...
        ranker=ranker,
        limit=top_k*2,
        output_fields=["uuid", "content"] # return not only ids but content for the colbert
    )
    ...
    # return ranked
        ...
        # Format results for the reranker
